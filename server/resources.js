...
export const RESOURCES = {
  ...
  surahs: {
    ...
    fields: [
      ...
      { name: 'name_meaning', label: 'Атауының мағынасы', type: 'text' },
  ...
  ayahs: {
    ...
    fields: [
      ...
      { name: 'translation_source', label: 'Аударма дереккөзі', type: 'text', help: 'мысалы: Халифа Алтай' },
      { name: 'global_number', label: 'Жалпы аят нөмірі (аудио үшін)', type: 'number' },
  ...
  words: {
    ...
    fields: [
      ...
      { name: 'level', label: 'Деңгей', type: 'select', options: LEVELS, list: true },
      { name: 'topic', label: 'Тақырып', type: 'text', list: true },
